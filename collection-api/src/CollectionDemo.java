...
public class CollectionDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("--Iterating over merged colleciton");
		for(String e: ar) {
		...
		for(String e: tree)System.out.println(e);
		
		System.out.println("-- Treaversing over sorted collection using Advanced For-each");
